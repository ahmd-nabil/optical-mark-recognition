...
# Reading images
main_paper = cv2.imread("c:/users/ahmed/Desktop/OMR4.jpg")
...
main_paper_blur = cv2.GaussianBlur(main_paper_gray, (5, 5),
...
bubbled_thresh = cv2.threshold(questions_image_gray, 0, 255, cv2.THRESH_BINARY_INV | cv2.THRESH_OTSU)[
...
# creating an answer dict

def list_to_json():
    answers_json = json.dumps(bubbled)
    return answers_json
